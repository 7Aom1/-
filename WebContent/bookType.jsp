...
<%@ page import="com.bookType.BookTypeDB" %>
...
<td width="18%" align="right">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="20%" bgcolor="#F9D16B">图书类型号</td>
    <td width="25%" bgcolor="#F9D16B">图书类型名称</td>
    <td width="25%" bgcolor="#F9D16B">可借天数</td>
...
<%
  ...
  <tr align="center">
    ...
    <td align="center"><a href="bookType?action=bookTypeModifyQuery&ID=<%=ID%>">修改</a></td>
